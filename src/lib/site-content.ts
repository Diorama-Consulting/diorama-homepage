...
export const CORE_POSITIONING = [
  ...
  'We can help you create defensible growth, reduce risk and accelerate value creation through fractional leadership, pragmatic AI and data strategy, platform modernisation, and organisation design. We also advise UK charities on AI and Digital Strategy.',
];
