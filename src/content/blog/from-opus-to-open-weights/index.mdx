...
description: >-
  Why one developer moved his AI coding workflow off Claude Code to
  pi.dev and DigitalOcean's pay-as-you-go Serverless Inference.
pubDate: 2026-08-01
...
Just before publishing this post, DigitalOcean [announced support for Kimi K3](https://ideas.digitalocean.com/changelog/now-available-kimi-k3-from-moonshot-ai) via Serverless Inference. In pricing terms it is roughly twice as expensive as DeepSeek v4 Pro and about twenty times more expensive than DeepSeek v4 Flash. If we pro rata my relatively high usage over three days as a starting point, this equates to roughly $40/month for access to a model that [leaped to the top of the coding charts](https://dioramaconsulting.co.uk/insights/the-ai-world-cup-may-have-no-single-winner/) at launch overtaking Anthropic's Fable:
...
I updated my key to access Kimi K3 and adjusted my models.json to add support with the following entry:
