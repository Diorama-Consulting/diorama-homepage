...
pubDate: '2025-10-04'
heroImage: 'https://substackcdn.com/image/fetch/$s_!6y7f!,w_1360,c_limit,f_auto,q_auto:best,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F08eec16c-8156-4ad8-9107-d54ee6cfbcbf_1024x1024.png'
link: 'https://cxai100.substack.com/p/75-years-of-the-turing-test'
---
...
![First page of Turing's 1951 lecture](./images/turing-1951-lecture.png)
...
![Slide referencing the Eliza chatbot](./images/eliza-slide.png)
...
![Sketch of how coding has changed over Kay's career](./images/kay-coding-sketch.png)

### Panel: What Did Turing Mean?

The first panel I attended revisited Turing's original framing:

![Panel slide on Turing's original framing](./images/turing-framing-slide.png)
...
![Slide from Gary Marcus's keynote](./images/marcus-keynote-slide.png)
...
![Slide mapping AI capabilities onto Kahneman's two systems](./images/kahneman-systems-slide.png)
...
![Panel discussing whether the Turing Test is still relevant](./images/turing-relevant-panel.png)
...
![Slide from Sir Nigel Shadbolt's keynote](./images/shadbolt-keynote-slide.png)
...
![Slide showing varieties of AI](./images/varieties-of-ai-slide.png)
...
![Final panel discussing the future of AGI](./images/agi-future-panel.png)
...
![Slide referencing OpenAI's Sora launch](./images/sora-launch-slide.png)
...
![Slide on the ramifications of unregulated AI](./images/ramifications-slide.png)
